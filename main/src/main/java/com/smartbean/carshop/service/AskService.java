...
public class AskService {
    ...
    public AskService(TASyncHttpClient syncHttpClient){
        this.syncHttpClient = syncHttpClient;
    }

    public AskService(AsyncHttpClient asyncHttpClient){
        this.asyncHttpClient = asyncHttpClient;
    }

    public AskService(AsyncHttpClient asyncHttpClient, TASyncHttpClient syncHttpClient){
        this.asyncHttpClient = asyncHttpClient;
        this.syncHttpClient = syncHttpClient;
    }
